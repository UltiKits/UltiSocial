...
import com.ultikits.plugins.social.i18n.UltiSocialLanguageCatalogueTest.Catalogue;
 ...
 * ({@link UltiSocialLanguageCatalogueTest#loadModuleCatalogues()}: the framework's own {@link Language},
...
public final class CatalogueText {
    ...
    public static Map<String, String> entries(String code) {
        try {
            for (Catalogue c : UltiSocialLanguageCatalogueTest.loadModuleCatalogues()) {
